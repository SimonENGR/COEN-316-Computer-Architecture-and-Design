...
set_property -dict { PACKAGE_PIN U18 IOSTANDARD LVCMOS33 } [ get_ports { read_a[0] } ];
set_property -dict { PACKAGE_PIN T18 IOSTANDARD LVCMOS33 } [ get_ports { read_a[1] } ];
set_property -dict { PACKAGE_PIN R17 IOSTANDARD LVCMOS33 } [ get_ports { read_b[0] } ];
set_property -dict { PACKAGE_PIN R13 IOSTANDARD LVCMOS33 } [ get_ports { read_b[1] } ];

set_property -dict { PACKAGE_PIN T8 IOSTANDARD LVCMOS33  } [ get_ports { write_address[0] } ];
set_property -dict { PACKAGE_PIN U8 IOSTANDARD LVCMOS33  } [ get_ports { write_address[1] } ];
set_property -dict { PACKAGE_PIN R16 IOSTANDARD LVCMOS33 } [ get_ports { write } ];
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk]
set_property -dict { PACKAGE_PIN T13 IOSTANDARD LVCMOS33 } [ get_ports { clk } ];
